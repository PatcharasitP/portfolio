...
export const CONTENT = {
  ...
  stats: [
    { n: "4", label: { th: "ระบบที่ใช้งานจริงบนอินเทอร์เน็ต", en: "Systems live in production" } },
    ...
    { n: "12×", label: { th: "ความเร็วที่ปรับปรุงได้ (วัดจริง)", en: "Measured speed improvement" } },
  ],
  ...
  projectsNote: {
    ...
    en: "All personal projects built outside of work, and every one is live and open source.",
  },
  ...
  projects: [
    {
      id: "bkk-complaints",
      period: { th: "ก.ย. 2026", en: "Sep 2026" },
    ...
    {
      id: "kit-family",
      tag: { th: "เว็บแอป, ตระกูลเครื่องมือ", en: "Web apps, Product family" },
      title: { th: "The Kit family: ชุดเว็บเครื่องมือที่ไม่ส่งไฟล์ขึ้นเซิร์ฟเวอร์", en: "The Kit family: browser tools that never upload your files" },
      period: { th: "ก.ย. 2026 ถึงปัจจุบัน", en: "Sep 2026 to present" },
      // ตัวเลขวัดบนเว็บจริง 24/09/2026 สลับยิงเว็บตัวอย่าง ILoveMyJob กับ FileKit เงื่อนไขเดียวกับ FileKit tests/browser_perf.py
      // (มือถือ 390x780, 1.6 Mbps, latency 150ms, CPU ช้า 4 เท่า) 2 ชุด ชุดละ 7 รอบ มัธยฐาน 5,062 กับ 406 ms = 12.5 เท่า ปัดลงเป็น 12
      // หลักฐาน .claude/evidence/2026-09-24-portfolio-refresh/fcp_compare_production_run1.json, _run2.json, filekit_perf_production.txt
      results: {
        th: ["เปิดหน้าแรกบนมือถือเน็ตช้าเร็วกว่าเว็บตัวอย่างที่ศึกษา 12 เท่า จาก 5.1 เหลือ 0.4 วินาที หน้าแรกโหลดแค่ 146 KB",
             "FileKit 64 เครื่องมือ กับ FlowKit ผัง 9 ชนิด ไฟล์ของผู้ใช้ไม่ออกจากเครื่องเลย",
             "เทสอัตโนมัติ 126 ชุดคุม FileKit ทุกครั้งก่อนปล่อย"],
        en: ["12× faster first paint than the reference site on a throttled phone, 5.1 s down to 0.4 s, with a 146 KB landing page",
             "FileKit's 64 tools plus FlowKit's 9 diagram types, and files never leave the device",
             "126 automated test suites gate every FileKit release"],
      },
      live: "https://patcharasitp.github.io/filekit/",
      live2: { href: "https://patcharasitp.github.io/flowkit/", label: "FlowKit" },
      code: "https://github.com/PatcharasitP/filekit",
      stack: ["JavaScript", "Web Workers", "PWA", "pdf.js", "SheetJS", "Tesseract.js", "draw.io embed", "Mermaid"],
      carl: {
        th: [
          ["โจทย์", "เว็บแปลงไฟล์ที่คนใช้กันต้องอัปโหลดเอกสารขึ้นเซิร์ฟเวอร์คนอื่น ซึ่งใช้กับเอกสารภายในไม่ได้ และเว็บตัวอย่างที่ผมศึกษาโหลดไลบรารีทั้ง 9 ตัวตั้งแต่หน้าแรก"],
          ["สิ่งที่ทำ", "เริ่มจาก FileKit ที่ประมวลผลในเบราว์เซอร์ล้วน หน้าแรกไม่โหลดไลบรารีเลย ดึงเฉพาะตอนเปิดเครื่องมือนั้นจริง จนโตเป็น 64 เครื่องมือ (PDF, Word, Excel, รูปภาพ, Power BI) แล้วแยก FlowKit ออกมาเป็นเว็บพี่น้องสำหรับวาดผัง 9 ชนิด รวมถึงวางโค้ด flow ของ Power Automate แล้วได้ผังทันที ทั้งสองเว็บใช้ดีไซน์ชุดเดียวกันและลิงก์ถึงกัน"],
          ["ผลลัพธ์", "หน้าแรกของ FileKit เปิดบนมือถือเน็ตช้าใน 0.4 วินาที ส่วนเว็บตัวอย่างที่ศึกษาใช้ 5.1 วินาที (วัดบนเว็บจริงทั้งคู่ สลับยิงด้วยเงื่อนไขเดียวกัน มัธยฐาน 14 รอบ) โหลดหน้าแรก 146 KB และมีเทสอัตโนมัติ 126 ชุดรันก่อนปล่อยทุกครั้ง"],
        ...
        en: [
          ...
          ["Action", "Started with FileKit, which runs entirely in the browser: the landing page loads zero libraries and each tool fetches only what it needs. It grew to 64 tools across PDF, Word, Excel, images and Power BI. I then split out FlowKit as a sister site that draws 9 kinds of diagrams, including turning pasted Power Automate flow code into a diagram. Both share one design system and link to each other."],
          ["Result", "FileKit's landing page paints in 0.4 s on a throttled phone, while the reference site takes 5.1 s (both live, measured alternately under the same conditions, median of 14 runs). The landing page weighs 146 KB, and 126 automated test suites run before every release."],
    ...
    {
      id: "laundromat",
      period: { th: "มิ.ย. 2026 ถึงปัจจุบัน", en: "Jun 2026 to present" },
    ...
    {
      id: "pqframework",
      period: { th: "มิ.ย. ถึง ก.ค. 2026", en: "Jun to Jul 2026" },
    ...
    {
      id: "automation",
      period: { th: "มิ.ย. ถึง พ.ย. 2025", en: "Jun to Nov 2025" },
  ...
  experience: [
    {
      period: { th: "มี.ค. 2026 ถึงปัจจุบัน", en: "Mar 2026 to present" },
    ...
    {
      period: { th: "ธ.ค. 2024 ถึง มี.ค. 2025", en: "Dec 2024 to Mar 2025" },
  ...
  education: [
    { period: { th: "2021 ถึง 2025", en: "2021 to 2025" },
    ...
    { period: { th: "2018 ถึง 2021", en: "2018 to 2021" },
